	...
	public static class Health {
		...
		public static void health(PlayerTickEvent event) {
			...
			if (entity.hasItemInSlot(EquipmentSlotType.CHEST)
					&& EnchantmentHelper.getEnchantmentLevel(Enchantments.HEALTH.get(),
							entity.getItemStackFromSlot(EquipmentSlotType.CHEST)) > 0) {

				EnchantmentUtils.AddEffectBasedOnLevelEntity(entity, Enchantments.HEALTH.get(), 1, 10,
						Effects.ABSORPTION, EquipmentSlotType.CHEST);
				EnchantmentUtils.AddEffectBasedOnLevelEntity(entity, Enchantments.HEALTH.get(), 2, 10,
						Effects.ABSORPTION, EquipmentSlotType.CHEST);
				EnchantmentUtils.AddEffectBasedOnLevelEntity(entity, Enchantments.HEALTH.get(), 3, 10,
						Effects.ABSORPTION, EquipmentSlotType.CHEST);
				EnchantmentUtils.AddEffectBasedOnLevelEntity(entity, Enchantments.HEALTH.get(), 4, 10,
						Effects.ABSORPTION, EquipmentSlotType.CHEST);
