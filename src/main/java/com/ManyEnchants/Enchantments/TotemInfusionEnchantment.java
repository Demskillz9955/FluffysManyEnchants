...
public class TotemInfusionEnchantment extends Enchantment{
	...
	public static class Infusion{
		@SubscribeEvent
		public static void Infused(PlayerTickEvent event) {
			PlayerEntity player = event.player;
			if (player.hasItemInSlot(EquipmentSlotType.CHEST) 
					&& EnchantmentHelper.getEnchantmentLevel(Enchantments.TOTEM_INFUSION.get(),player.getItemStackFromSlot(EquipmentSlotType.CHEST)) > 0) {
