	  ...
	  public static class Enrich{
		  ...
		  public static void Enrichment(RightClickBlock event) {
				...
				if (player.hasItemInSlot(EquipmentSlotType.MAINHAND) 
						...
						&& EnchantmentHelper.getEnchantmentLevel(Enchantments.ENRICHMENT.get(),player.getItemStackFromSlot(EquipmentSlotType.MAINHAND)) == 1) {
					...
					if(worldIn.getBlockState(event.getPos()) == Blocks.REDSTONE_ORE.getDefaultState().getBlockState())
				...
				if (player.hasItemInSlot(EquipmentSlotType.MAINHAND) 
						...
						&& EnchantmentHelper.getEnchantmentLevel(Enchantments.ENRICHMENT.get(),player.getItemStackFromSlot(EquipmentSlotType.MAINHAND)) == 2) {
