...
public class LightnessEnchantment extends Enchantment{
	...
	if (entity.hasItemInSlot(EquipmentSlotType.FEET) 
						...
						&& EnchantmentHelper.getEnchantmentLevel(Enchantments.LIGHTNESS.get(),entity.getItemStackFromSlot(EquipmentSlotType.FEET)) > 0) {
		EnchantmentUtils.AddEffectBasedOnLevelEntity(entity, Enchantments.LIGHTNESS.get(), 1,10, Effects.JUMP_BOOST, EquipmentSlotType.FEET);
		EnchantmentUtils.AddEffectBasedOnLevelEntity(entity, Enchantments.LIGHTNESS.get(), 2,10, Effects.JUMP_BOOST, EquipmentSlotType.FEET);
		EnchantmentUtils.AddEffectBasedOnLevelEntity(entity, Enchantments.LIGHTNESS.get(), 3,10, Effects.JUMP_BOOST, EquipmentSlotType.FEET);
