...
public class EnchantmentAddEffect extends Enchantment {
	...
	public EnchantmentAddEffect(Rarity rarityIn, EnchantmentType typeIn, EquipmentSlotType[] slots, int minLevel,
			int maxLevel, boolean curse, boolean villagerTrade, boolean isTreasure, boolean genInLoot,
			boolean applyAtEnchant) {
